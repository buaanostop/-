...
class Ui_TestWindow(object):
    def setupUi(self, TestWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10, 170, 1011, 151))
        self.gridLayoutWidget.setObjectName("gridLayoutWidget")
        self.gridLayout = QtWidgets.QGridLayout(self.gridLayoutWidget)
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.gridLayout.setObjectName("gridLayout")
        self.InputAssignmentButton = QtWidgets.QPushButton(self.gridLayoutWidget)
        ...
        self.connectDeviceButton = QtWidgets.QPushButton(self.gridLayoutWidget)
        ...
        self.addPointButton = QtWidgets.QPushButton(self.gridLayoutWidget)
        ...
        self.chooseTypeButton = QtWidgets.QPushButton(self.gridLayoutWidget)
    ...
    def retranslateUi(self, TestWindow):
        ...
        self.addPointButton.setText(_translate("TestWindow", "加入/查看当前屏幕中点的坐标"))
