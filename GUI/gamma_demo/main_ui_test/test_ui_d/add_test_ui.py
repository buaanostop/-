...
class Ui_Add_test(object):
    def setupUi(self, Add_test):
        ...
        self.verticalLayout_2.addWidget(self.touch_pos)
        self.addTouchPoint = QtWidgets.QPushButton(self.single_point_touch_test)
        self.addTouchPoint.setObjectName("addTouchPoint")
        self.verticalLayout_2.addWidget(self.addTouchPoint)
        self.single_point_touch_test1.addLayout(self.verticalLayout_2, 0, 0, 1, 1)
        ...
        self.pushButton = QtWidgets.QPushButton(Add_test)
        self.pushButton.setGeometry(QtCore.QRect(160, 370, 93, 28))
    ...
    def retranslateUi(self, Add_test):
        ...
        self.addTouchPoint.setText(_translate("Add_test", "添加当前屏幕点的坐标"))
...
"如果没有设置好每个点的坐标，会有相应提示，请补充完成"))
        ...
        self.pushButton.setText(_translate("Add_test", "PushButton"))
