...
class Ui_Add_test(object):
    def setupUi(self, Add_test):
        ...
        self.v_m_touch_pos_x.setPlaceholderText("")
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(10, 60, 631, 217))
        self.layoutWidget2.setObjectName("layoutWidget2")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.layoutWidget2)
        self.gridLayout_3.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.m_drag_start_p = QtWidgets.QLabel(self.layoutWidget2)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.v_m_drag_start_p_y = QtWidgets.QLineEdit(self.layoutWidget2)
        ...
        self.m_drag_end_p = QtWidgets.QLabel(self.layoutWidget2)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.v_m_drag_end_p_y = QtWidgets.QLineEdit(self.layoutWidget2)
        ...
        self.multiDragNextButton = QtWidgets.QPushButton(self.layoutWidget2)
        ...
        self.gridLayout_3.addWidget(self.multiDragNextButton, 1, 3, 1, 1)
        self.m_drag_loop_num = QtWidgets.QLabel(self.layoutWidget2)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.m_drag_i_time = QtWidgets.QLabel(self.layoutWidget2)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.m_drag_time = QtWidgets.QLabel(self.layoutWidget2)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.m_drag_trip_i_time = QtWidgets.QLabel(self.layoutWidget2)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.confirmMultiDragButton = QtWidgets.QPushButton(self.layoutWidget3)
        ...
        self.horizontalLayout_4.addWidget(self.confirmMultiDragButton)
        ...
        self.finishButton = QtWidgets.QPushButton(self.layoutWidget4)
        ...
        item = QtWidgets.QListWidgetItem()
        self.currentQueueList.addItem(item)
        self.layoutWidget5 = QtWidgets.QWidget(Add_test)
        self.layoutWidget5.setGeometry(QtCore.QRect(420, 360, 243, 42))
        self.layoutWidget5.setObjectName("layoutWidget5")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.layoutWidget5)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.clearAssignmentButton = QtWidgets.QPushButton(self.layoutWidget5)
        ...
        self.addToQueueButton = QtWidgets.QPushButton(self.layoutWidget5)
        ...
        self.confirmMultiDragButton.clicked.connect(self.now_drag_num.show)
        self.confirmMultiDragButton.clicked.connect(self.v_m_drag_num.hide)
        self.confirmMultiDragButton.clicked.connect(self.confirmMultiDragButton.hide)
        self.clearAssignmentButton.clicked.connect(self.now_drag_num.hide)
    ...
    def retranslateUi(self, Add_test):
        ...
        self.touch_i_time.setWhatsThis(_translate("Add_test", "单位：秒"))
        ...
        self.press_i_time.setWhatsThis(_translate("Add_test", "单位：秒"))
        ...
        self.m_touch_point_num.setWhatsThis(_translate("Add_test", "修改个数将会清空之前输入的点的信息"))
...
"如果没有设置好每个点的坐标，会有相应提示，请补充完成"))
        self.pointSelectComboBox.setItemText(0, _translate("Add_test", "未确认点的个数"))
        ...
        self.r_touch_p2.setText(_translate("Add_test", "随机范围右上角"))
        self.r_touch_p1.setText(_translate("Add_test", "随机范围左下角"))
        ...
        self.drag_p2.setText(_translate("Add_test", "终点2坐标：(X,Y)"))
        ...
        self.multiDragNextButton.setText(_translate("Add_test", "确认并输入下次滑动"))
        self.m_drag_loop_num.setText(_translate("Add_test", "滑动循环的遍数："))
        self.v_m_drag_loop_num.setPlaceholderText(_translate("Add_test", "1"))
        self.m_drag_i_time.setWhatsThis(_translate("Add_test", "一遍内有1到9次滑动，当滑动次数大于1时，该输入框设置的是这几次的间隔"))
        ...
        self.m_drag_trip_i_time.setWhatsThis(_translate("Add_test", "该输入框设置的是遍与遍之间的滑动间隔，即一遍的n次滑动结束以后，直到下一个n次滑动开始的间隔"))
        ...
        self.randomDragLeftDownPoint.setWhatsThis(_translate("Add_test", "随机范围是一个矩形，这是这个矩形左下角点的坐标，输入(x,y)形式"))
        self.randomDragLeftDownPoint.setText(_translate("Add_test", "随机范围左下角"))
        ...
        self.randomDragRightUpPoint.setWhatsThis(_translate("Add_test", "随机范围是一个矩形，这是这个矩形右下角点的坐标，输入(x,y)形式"))
        self.randomDragRightUpPoint.setText(_translate("Add_test", "随机范围右上角"))
        ...
        item.setText(_translate("Add_test", "test1"))
        item = self.currentQueueList.item(1)
        item.setText(_translate("Add_test", "test2"))
        item = self.currentQueueList.item(2)
        item.setText(_translate("Add_test", "test3"))
