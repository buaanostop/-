...
class Ui_TestWindow(object):
    def setupUi(self, TestWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(11, 351, 751, 401))
        ...
        self.widget.setGeometry(QtCore.QRect(770, 390, 254, 328))
        ...
        self.deleteAllTestButton = QtWidgets.QPushButton(self.widget)
