...
class Ui_TestWindow(object):
    def setupUi(self, TestWindow):
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(60, 110, 911, 181))
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(680, 290, 341, 61))
    ...
    def retranslateUi(self, TestWindow):
        ...
        self.errorCheckBox.setText(_translate("TestWindow", "显示adb日志Warning错误"))
        self.warningCheckBox.setText(_translate("TestWindow", "显示adb日志Error错误"))
