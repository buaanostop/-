...
class Ui_TestWindow(object):
    def setupUi(self, TestWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(60, 110, 911, 181))
        self.layoutWidget.setObjectName("layoutWidget")
        self.gridLayout = QtWidgets.QGridLayout(self.layoutWidget)
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.gridLayout.setObjectName("gridLayout")
        self.connectDeviceButton = QtWidgets.QPushButton(self.layoutWidget)
        ...
        self.InputAssignmentButton = QtWidgets.QPushButton(self.layoutWidget)
        ...
        self.addPointButton = QtWidgets.QPushButton(self.layoutWidget)
        ...
        self.chooseTypeButton = QtWidgets.QPushButton(self.layoutWidget)
        ...
        self.warningCheckBox = QtWidgets.QCheckBox(self.horizontalLayoutWidget)
        self.warningCheckBox.setEnabled(True)
        self.warningCheckBox.setObjectName("warningCheckBox")
        self.horizontalLayout_2.addWidget(self.warningCheckBox)
        self.errorCheckBox = QtWidgets.QCheckBox(self.horizontalLayoutWidget)
        self.errorCheckBox.setObjectName("errorCheckBox")
        self.horizontalLayout_2.addWidget(self.errorCheckBox)
        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(11, 351, 751, 411))
        ...
        self.clearReportButton = QtWidgets.QPushButton(self.report_list)
        self.clearReportButton.setGeometry(QtCore.QRect(610, 352, 131, 31))
        self.clearReportButton.setObjectName("clearReportButton")
        self.tabWidget.addTab(self.report_list, "")
        self.layoutWidget1 = QtWidgets.QWidget(self.centralwidget)
        self.layoutWidget1.setGeometry(QtCore.QRect(770, 390, 254, 328))
        ...
        self.deleteAllTestButton = QtWidgets.QPushButton(self.layoutWidget1)
        self.deleteAllTestButton.setMinimumSize(QtCore.QSize(250, 40))
        self.deleteAllTestButton.setMaximumSize(QtCore.QSize(250, 40))
        self.deleteAllTestButton.setObjectName("deleteAllTestButton")
        self.verticalLayout.addWidget(self.deleteAllTestButton)
        ...
        self.startButton.clicked.connect(self.deleteAllTestButton.hide)
        self.stopButton.clicked.connect(self.deleteAllTestButton.show)
        self.clearReportButton.clicked.connect(self.reportList.clear)
    ...
    def retranslateUi(self, TestWindow):
        ...
        self.clearReportButton.setText(_translate("TestWindow", "清空测试报告"))
        ...
        self.deleteAllTestButton.setText(_translate("TestWindow", "删除所有测试队列"))
