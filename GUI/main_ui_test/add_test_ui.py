...
class Ui_Add_test(object):
    def setupUi(self, Add_test):
        ...
        self.drag_time = QtWidgets.QLabel(self.drag_test)
        self.drag_time.setObjectName("drag_time")
        self.drag_test1.addWidget(self.drag_time, 4, 0, 1, 1)
        self.v_drag_time = QtWidgets.QLineEdit(self.drag_test)
        self.v_drag_time.setMinimumSize(QtCore.QSize(0, 30))
        self.v_drag_time.setMaximumSize(QtCore.QSize(16777215, 30))
        self.v_drag_time.setObjectName("v_drag_time")
        self.drag_test1.addWidget(self.v_drag_time, 4, 1, 1, 1)
        ...
        self.addPointConfirmButton = QtWidgets.QPushButton(Add_test)
        self.addPointConfirmButton.setGeometry(QtCore.QRect(155, 360, 93, 40))
        ...
        self.choosePointBox = QtWidgets.QComboBox(Add_test)
        self.choosePointBox.setGeometry(QtCore.QRect(11, 369, 137, 24))
        self.choosePointBox.setMinimumSize(QtCore.QSize(0, 0))
        self.choosePointBox.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.choosePointBox.setFont(font)
        self.choosePointBox.setObjectName("choosePointBox")
        self.choosePointBox.addItem("")
        self.addPointConfirmButton_2 = QtWidgets.QPushButton(Add_test)
        self.addPointConfirmButton_2.setGeometry(QtCore.QRect(255, 360, 93, 40))
        self.addPointConfirmButton_2.setMinimumSize(QtCore.QSize(0, 40))
        self.addPointConfirmButton_2.setMaximumSize(QtCore.QSize(16777215, 40))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.addPointConfirmButton_2.setFont(font)
        self.addPointConfirmButton_2.setObjectName("addPointConfirmButton_2")
        ...
        self.addPointConfirmButton_2.clicked.connect(Add_test.choose_point_confirm_2)
        self.tabWidget.currentChanged['int'].connect(Add_test.tab_changed)
        self.choosePointBox.currentIndexChanged['int'].connect(Add_test.box_changed)
...
"如果没有设置好每个点的坐标，会有相应提示，请补充完成"))
        ...
        self.drag_time.setWhatsThis(_translate("Add_test", "<html><head/><body><p>每次滑动时间。取值范围为&gt;0的浮点数。不填默认为1。单位为秒。</p></body></html>"))
        self.drag_time.setText(_translate("Add_test", "滑动持续时间："))
        self.v_drag_time.setPlaceholderText(_translate("Add_test", "1"))
...
"如果没有设置好每个点的坐标，会有相应提示，请补充完成"))
        ...
        self.addPointConfirmButton.setText(_translate("Add_test", "填入点1"))
        self.choosePointBox.setItemText(0, _translate("Add_test", "将已保存的点"))
        self.addPointConfirmButton_2.setText(_translate("Add_test", "填入点2"))
