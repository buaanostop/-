...
class MyQueueList(QtWidgets.QListWidget):  #重写ListWidget中的拖拽方法
    ...
    def dropEvent(self,event):
        ...
        super(MyQueueList,self).dropEvent(event)
        print(self.currentRow())
    def dragMoveEvent(self,event):
        super(MyQueueList,self).dragMoveEvent(event)
    def dragEnterEvent(self,event):
        super(MyQueueList,self).dragEnterEvent(event)
class Ui_TestWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.queueList = MyQueueList(self.centralwidget)
        ...
        self.finishInputButton.setGeometry(QtCore.QRect(810, 550, 101, 31))
